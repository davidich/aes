...
namespace Xunit
{
    ...
    partial class Assert
    {
        ...
        {
            Xunit.Assert.GuardArgumentNotNull("collection", collection);
            Xunit.Assert.GuardArgumentNotNull("action", action);
        ...
        {
            Xunit.Assert.GuardArgumentNotNull("comparer", comparer);
            Xunit.Assert.GuardArgumentNotNull("collection", collection);
        ...
        {
            Xunit.Assert.GuardArgumentNotNull("collection", collection);
            Xunit.Assert.GuardArgumentNotNull("filter", filter);
        ...
        {
            Xunit.Assert.GuardArgumentNotNull("collection", collection);
            Xunit.Assert.GuardArgumentNotNull("predicate", predicate);
