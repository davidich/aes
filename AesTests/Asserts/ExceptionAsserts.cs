...
namespace Xunit
{
    ...
    partial class Assert
    {
        ...
        {
            Xunit.Assert.GuardArgumentNotNull("exceptionType", exceptionType);
            ...
            where T : ArgumentException
        {
            ...
            Xunit.Assert.Equal(paramName, ex.ParamName);
            return ex;
        }
        ...
        public static async Task<T> ThrowsAsync<T>(string paramName, Func<Task> testCode)
            where T : ArgumentException
        {
            var ex = await Xunit.Assert.ThrowsAsync<T>(testCode);
            Xunit.Assert.Equal(paramName, ex.ParamName);
            return ex;
        }
    }
